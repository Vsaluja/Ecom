...
const Carousel = ({ category, onSale, subCategory, title, productsProvided }) => {
    ...
    const filterProducts = () => {
        ...
        if (productsProvided?.length > 0) {
            return setItems(productsProvided)
        }
    ...
    }, [products, category, subCategory, productsProvided?.length])
