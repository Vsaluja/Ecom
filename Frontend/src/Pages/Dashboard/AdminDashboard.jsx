...
const AdminDashboard = () => {
    ...
    return (
        <div className='flex-grow py-5 bg-[color:var(--admin-body-bg)]'>
            <Container className={'relative h-[100%] '}>

                <AdminNav />
                <div className='flex justify-around items-start mt-5 flex-wrap gap-20'>

                    <div className="box bg-[#252525]  rounded-2xl w-[500px] h-[250px] rounded p-4 flex flex-col items-center justify-center  gap-10 text-white">
                    ...
                    <div className="box bg-black rounded-2xl w-[500px] h-[250px] rounded p-4 flex flex-col items-center justify-center  gap-10 text-white ">
